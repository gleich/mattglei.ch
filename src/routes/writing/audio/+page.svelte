...
<Writing writing={writings.get('audio')!}>
	<WritingSection title="The Start">
		...
		<br />
		<p>
			For Christmas of last year, only a few months after I started using those Etymotics, I got
			some new pair of Etymotics as well as my first speaker setup! Here is all of the gear that I
			got then:
		</p>
	</WritingSection>
</Writing>
